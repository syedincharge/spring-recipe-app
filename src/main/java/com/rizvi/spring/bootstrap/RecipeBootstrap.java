...
import com.rizvi.spring.repositories.CategoryRepository;
import com.rizvi.spring.repositories.RecipeRepository;
import com.rizvi.spring.repositories.UnitOfMeasureRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        guacRecipe.setUrl("http://simplyrecipes.com/recipes/perfect_guacamole/");
        guacRecipe.setServings(4);
        ...
        tacosRecipe.setUrl("http://simplyrecipes.com/recipes/spicy_grilled_chicken_tacos/");
